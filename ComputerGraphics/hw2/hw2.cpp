...
BEGIN_MESSAGE_MAP(Chw2App, CWinAppEx)
...
BOOL Chw2App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(Chw2Doc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(Chw2View));
	if (!pDocTemplate)
		return FALSE;
...
// Chw2App 사용자 지정 로드/저장 방법

void Chw2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Chw2App::LoadCustomState()
{
}

void Chw2App::SaveCustomState()
{
}
